...
import static com.udacity.stockhawk.data.Contract.Quote.COLUMN_NAME;
            ...
            case QUOTE:
                ...
                try {
                    for (ContentValues value : values) {
                        if (value.get(COLUMN_PRICE) == null) {
                            value.put(COLUMN_PRICE, 0.0);
                            value.put(COLUMN_ABSOLUTE_CHANGE, 0.0);
                            value.put(COLUMN_PERCENTAGE_CHANGE, 0.0);
                        }
                        if (value.get(COLUMN_NAME) == null)
                                value.put(COLUMN_NAME, "");
                        db.insert(
                                Contract.Quote.TABLE_NAME,
                                null,
                                value
