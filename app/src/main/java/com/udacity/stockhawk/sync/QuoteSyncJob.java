...
public final class QuoteSyncJob {
    ...
    static void getQuotes(Context context) {
        ...
        try {
            ...
            while (iterator.hasNext()) {
                ...
                float price = 0.0f, change = 0.0f, percentChange = 0.0f;
            ...
            // remove stocks that don't exist
            ((StockHawkApp)context).threadHandler.obtainMessage(EXCEPTION, symbol).sendToTarget();
    ...
    private static void schedulePeriodic(Context context) {
        ...
        PeriodicTask task = new PeriodicTask.Builder()
                ...
                .setTag(Integer.toHexString(PERIODIC_ID))
                .setPeriod(PERIOD).build();
...
*/
        GcmNetworkManager scheduler = GcmNetworkManager.getInstance(context);
    ...
    // backported version, no backoff criteria :(
    public static synchronized void syncImmediately(Context context) {
        ...
        if (networkInfo != null && networkInfo.isConnectedOrConnecting()) {
            ...
            .setService(QuoteJobService.class)
                    .setRequiredNetwork(NETWORK_STATE_ANY)
                    .setTag(Integer.toHexString(ONE_OFF_ID))
